...
@section('content')
    <div class="max-w-2xl p-6 mx-auto bg-white rounded-lg shadow-sm">
        <div class="mb-6">
            <h1 class="text-xl font-bold text-slate-800">Tambah Porter Baru</h1>
            <p class="text-sm text-slate-500">Masukkan informasi lengkap untuk menambahkan data porter.</p>
        </div>

        <form action="{{ route('admin.porter.store') }}" method="POST">
            @csrf
            <div class="space-y-5">
                <!-- Nama -->
                <div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        ...
                        <p class="text-slate-500">Bila dicentang, porter akan langsung berstatus aktif dan siap bertugas.
                        </p>
                    </div>
                </div>
            </div>
