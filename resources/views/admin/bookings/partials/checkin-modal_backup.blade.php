                        ...
                        <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <span
                                        class="absolute text-xs font-bold text-gray-500 -translate-y-1/2 right-4 top-1/2">
                                        m³
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <i
                                        class="absolute text-gray-400 -translate-y-1/2 left-4 top-1/2 fa-solid fa-tags"></i>
                                    <input readonly type="number" step="0.001" name="total_net_weight"
                                        class="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:bg-white focus:border-blue-500 transition-all outline-none font-bold text-gray-700 {{ $errors->has('field') ? 'border-red-500' : 'border-gray-100' }}">
                                    <span
                                        class="absolute text-xs font-bold text-gray-500 -translate-y-1/2 right-4 top-1/2">
                                        kg
                        ...
                        <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <i
                                        class="absolute text-gray-400 -translate-y-1/2 left-4 top-1/2 fa-solid fa-tags"></i>
                                    <input readonly type="number" step="0.001" name="total_gross_weight"
                                        class="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:bg-white focus:border-blue-500 transition-all outline-none font-bold text-gray-700 {{ $errors->has('field') ? 'border-red-500' : 'border-gray-100' }}">
                                    <span
                                        class="absolute text-xs font-bold text-gray-500 -translate-y-1/2 right-4 top-1/2">
                                        kg
