...
@section('content')
    <div class="mx-auto space-y-6 full-width">
        ...
        <div class="py-5 px-7 shadow-lg bg-white border-gray-100 rounded-[2.5rem]">
            ...
            <p class="mt-1 text-sm text-gray-800">Perbarui informasi akun dan keamanan data Anda.</p>
        </div>
        ...
        <div class="space-y-6">
            ...
            <form action="{{ route('admin.profile.update') }}" method="POST"
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        <label class="text-[11px] font-black text-gray-400 uppercase tracking-widest ml-1">Full
                            Name</label>
