<aside id="sidebar"
    ...
    <div
        class="sticky top-0 z-10 flex items-center justify-between px-6 py-8 bg-gray-900 border-b border-gray-800/50 rounded-t-2xl">
    ...
    <nav class="px-4 py-6 space-y-1.5 whitespace-nowrap">
