...
class DeliveryInboundExport implements FromCollection, WithStyles, WithEvents, WithMapping
{
    protected $id;
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('G1', "List of Irradiated Goods Inbound No." . ($booking->booking_code ?? ''));
