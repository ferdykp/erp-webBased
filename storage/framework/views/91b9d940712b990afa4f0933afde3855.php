        ...
        <div class="bg-white border border-gray-100 shadow-sm rounded-[2.5rem] overflow-hidden">
            ...
            <div class="px-8 pb-8">
                    ...
                    <div class="relative">
                        <div class="w-32 h-32 bg-white p-2 rounded-[2rem] shadow-xl">
                            <div
                                ...
                                <?php echo e(substr(auth('customer')->user()->username ?? 'U', 0, 1)); ?>
                ...
                <div>
                    ...
                    <h2 class="text-3xl font-black tracking-tight text-gray-900"><?php echo e(auth('customer')->user()->username ?? '-'); ?></h2>
                    <p class="italic font-medium text-gray-400">Customer ID:
                        #<?php echo e(str_pad(auth('customer')->id(), 5, '0', STR_PAD_LEFT)); ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white p-8 border border-gray-100 shadow-sm rounded-[2rem] space-y-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="mt-1 font-bold text-gray-800"><?php echo e(auth('customer')->user()->email ?? '-'); ?></p>
                    </div>
                    <div>
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Phone Number</label>
                        
                        <p class="mt-1 font-bold text-gray-800"><?php echo e(auth('customer')->user()->phone ?? '+62 812-3456-7890'); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ferdy/project-fl/beamCustom/resources/views/customer/profile/myprofile.blade.php ENDPATH**/ ?>