<?php $__env->startSection('content'); ?>
    <div class="w-full space-y-6">
        ...
        <div class="bg-white shadow-sm border border-gray-100 rounded-[2rem] overflow-hidden">
            ...
            <div class="p-8">
                ...
                <input type="hidden" id="in_customer_id" value="<?php echo e(auth('customer')->user()->id); ?>">

                
                <input type="hidden" id="display_booking_code_input">

                <form action="<?php echo e(route('customer.booking.store')); ?>" method="POST" enctype="multipart/form-data"
                    class="space-y-8">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            <label class="text-[11px] font-black text-gray-700 uppercase tracking-widest ml-1">Product
                                Name</label>
                            <input type="text" name="product_name" id="in_product_name" value="<?php echo e(old('product_name')); ?>"
                        ...
                        <div class="space-y-2">
                            <label class="text-[11px] font-black text-gray-700 uppercase tracking-widest ml-1">Product
                                Type</label>
                            <input type="text" name="product_type" id="in_product_type" value="<?php echo e(old('product_type')); ?>"
                                class="w-full px-5 py-3.5 bg-gray-50 border border-gray-100 rounded-2xl font-bold focus:border-blue-500 outline-none transition-all"
                                required>
                        </div>
                    </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="number" step="any" id="in_gross_pcs" name="gross_weight_per_pcs"
                                    value="<?php echo e(old('gross_weight_per_pcs')); ?>"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="number" step="any" id="in_net_pcs" name="net_weight_pcs"
                                    value="<?php echo e(old('net_weight_pcs')); ?>"
                                    class="w-full px-5 py-3.5 bg-gray-50 border border-gray-100 rounded-2xl font-bold outline-none"
                                    required>
                                <span
                                    class="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] font-black text-gray-400">KG</span>
                    ...
                    <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                        <div class="space-y-2">
                            <label class="text-[11px] font-black text-gray-700 uppercase tracking-widest ml-1">Total
                                Quantity</label>
                            <input type="number" id="in_qty" name="quantity" value="<?php echo e(old('quantity')); ?>"
                                class="w-full px-5 py-3.5 bg-gray-50 border border-gray-100 rounded-2xl font-bold outline-none"
                                required>
                        </div>
                        <div class="space-y-2">
    ...
    <?php echo $__env->make('customer.booking.booking_detail', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ferdy/project-fl/beamCustom/resources/views/customer/booking/create.blade.php ENDPATH**/ ?>