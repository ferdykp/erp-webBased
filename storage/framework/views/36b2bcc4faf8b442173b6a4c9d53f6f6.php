        ...
        <div class="flex w-full max-w-4xl overflow-hidden bg-white shadow-xl rounded-[2rem] border border-gray-100">
            ...
            <div class="relative flex-col justify-center hidden w-1/2 p-12 overflow-hidden text-white bg-blue-600 md:flex">
                ...
                <div class="absolute bottom-10 left-12">
                    <img src="<?php echo e(asset('img/logo-txt-removebg.png')); ?>" class="h-10 brightness-0 invert opacity-80"
                        alt="Logo">
                </div>
            </div>
                ...
                <div class="max-w-sm mx-auto">
                    <div class="mb-10 text-center md:text-left">
                        ...
                        <p class="mt-2 text-sm text-gray-500">Don't have an account? <a
                                href="<?php echo e(route('customer.register')); ?>"
                    ...
                    <form action="<?php echo e(route('customer.login')); ?>" method="POST" class="space-y-5">
                        <?php echo csrf_field(); ?>
                        <div>
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email')); ?>" required
                                ...
                                class="w-full px-5 py-4 mt-1 transition-all border <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?> outline-none bg-gray-50 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-600">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <span class="mt-1 ml-1 text-xs font-semibold text-red-500"><?php echo e($message); ?></span>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                <input type="password" name="password" id="password" required placeholder="••••••••"
                                    class="w-full px-5 py-4 transition-all border <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-gray-200 <?php unset($message);
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ferdy/project-fl/beamCustom/resources/views/customer/auth/login.blade.php ENDPATH**/ ?>