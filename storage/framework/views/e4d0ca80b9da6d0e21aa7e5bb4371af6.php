        ...
        <nav
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center justify-center h-10 text-white w-25 rounded-xl ">
                    ...
                    <img src="<?php echo e(asset('img/logo-txt-removebg.png')); ?>" class="h-10 w-25" alt="">
                </div>
        ...
        <footer class="px-6 py-10 bg-white border-t md:px-12 border-slate-100">
            <div
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <p class="text-[11px] font-bold text-slate-400 uppercase tracking-widest">© <?php echo e(date('Y')); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ferdy/project-fl/beamCustom/resources/views/landing.blade.php ENDPATH**/ ?>