<div class="overflow-x-auto">
    <table class="w-full border-collapse">
        ...
        <tbody class="divide-y divide-gray-50">
            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="transition-colors hover:bg-gray-50/50 group">
                        ...
                        <div class="max-w-xs space-y-2">
                            <?php $__currentLoopData = $booking->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative pl-4 border-l-2 border-blue-200">
                                    ...
                                    <p class="text-[11px] text-gray-500 font-medium"><?php echo e($product->quantity); ?>

                                        <?php echo e($product->unit); ?> • Min Dose: <?php echo e($product->dmin); ?>• Max Dose:
                                        <?php echo e($product->dmax); ?></p>
                                </div>
                    ...
                    <td class="px-8 py-6">
                        ...
                        <div class="flex justify-center">
                            <span
                                class="px-4 py-1.5 text-[10px] font-black uppercase tracking-widest rounded-full border <?php echo e($statusStyles); ?>">
                    ...
                    <td class="px-8 py-6 text-right">
                        <button onclick="openModal(<?php echo e($booking->id); ?>)"
...
<script>
    ...
    $(document).on('click', '.pagination a', function(event) {
        ...
        $.ajax({
            url: "<?php echo e(route('customer.dashboard')); ?>?page=" + page + "&search=" + query,
            headers: {
...
<?php /**PATH /Users/ferdy/project-fl/beamCustom/resources/views/customer/dashboard/table.blade.php ENDPATH**/ ?>